    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response && response.success) {
                ...
                const errorMessage = response?.message || "Failed to create room. Please try again.";
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => setFormData({ ...formData, resortId: parseInt(e.target.value) })}
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-amber-500 focus:border-transparent"
                            disabled={loading}
                            required
                        >
                    ...
                    <div className="flex space-x-3 pt-4">
                        ...
                        <button 
                            type="submit" 
                            disabled={loading || !formData.room_number.trim() || !formData.resortId} 
