...
const Page = () => {
  ...
  const filteredManagers = managerData.filter((manager) => {
    const matchesSearch = manager.username
      .toLowerCase()
            ...
            <Card classname="bg-white shadow-sm border border-gray-200 rounded-lg">
              <div>
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
                  <h1 className="text-2xl font-semibold">Manager Directory</h1>
              ...
              <div>
                ...
                {viewMode === "grid" && (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 auto-rows-fr">
                    {filteredManagers.map((manager) => (
                      <div
                        key={manager.UserId}
                        className="group relative bg-gradient-to-br from-white via-white to-purple-50/30 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100 hover:border-purple-200 overflow-hidden"
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex flex-col items-center mb-3">
                            <div className="relative">
                              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-100 to-purple-200 p-1 shadow-inner">
                                <Image
                                  src={manager.avatar || "/userPlaceholder.jpg"}
                                  width={44}
                                  height={44}
                                  className="w-full h-full rounded-lg object-cover"
                                  alt={manager.username || "Manager Avatar"}
                                  onError={(e) => {
                                    e.currentTarget.src =
                                      "/userPlaceholder.jpg";
                                  }}
                          ...
                          <div className="space-y-2 text-center">
                            <div>
                              <h3 className="font-bold text-base text-gray-900 group-hover:text-purple-800 transition-colors truncate">
                                {manager.username}
                              </h3>
                ...
                {/* Manager Cards - List View */}
                {viewMode === "list" && (
                  <div className="space-y-3">
                    {filteredManagers.map((manager) => (
                      <div
                        key={manager.UserId}
                        className="group relative bg-gradient-to-r from-white via-white to-purple-50/20 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer border border-gray-100 hover:border-purple-200 overflow-hidden"
                        onClick={() => handleEditUser(manager)}
                      >
                        {/* Status indicator */}
                        <div
                        ...
                        <div className="p-6 pl-8">
                          ...
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-4">
                              {/* Avatar */}
                              <div className="relative">
                                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-100 to-purple-200 p-1 shadow-inner">
                                  <Image
                                    src={
                                      manager.avatar || "/userPlaceholder.jpg"
                                    }
                                    width={52}
                                    height={52}
                                    className="w-full h-full rounded-lg object-cover"
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-1">
                                  ...
                                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-lg text-xs font-medium bg-purple-50 text-purple-700 border border-purple-200">
                                    {manager.role || "Manager"}
                                  </span>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center text-sm text-gray-900">
                                ...
                                <span>
                                  {manager.resorts?.name || "Not Assigned"}
                                </span>
                              </div>
                            </div>
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                            ...
                            <div className="opacity-0 group-hover:opacity-100 transition-all duration-200">
                              <div className="flex items-center text-purple-600 text-sm font-medium hover:text-purple-700">
                                <span>View Details</span>
                ...
                {/* No results message */}
                {filteredManagers.length === 0 && managerData.length > 0 && (
                ...
                <div className="mt-6 flex items-center justify-between text-sm text-gray-500 border-t border-gray-200 pt-4">
                  <span>
                    Showing {filteredManagers.length} of {managerData.length}{" "}
                    managers
                  </span>
                </div>
              </div>
